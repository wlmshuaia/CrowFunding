	...
	jRange.prototype = {
		...
		template: '<div class="slider-container">\
			<div class="back-bar">\
                ...
                <div class="pointer low"></div><div class="pointer-label">xxx</div>\
                <div class="pointer high"></div><div class="pointer-label">xxx</div>\
		...
		showPointerValue: function(pointer, position, animate) {
			...
			if ($.isFunction(this.options.format)) {
				...
				//text = '2016-03-07 13:15:00';
				text = fGetDateDetail(value);
			}
