...
<div class="admin-main">
    <div class="container-fluid">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="content">
                <form action="admin/Page/addPageHandle.do" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="one-con">
                        ...
                        <div class="one-content">
                            <div class="form-group">
                                <label for="proname" class="control-label"><span class="red">*</span>名称</label>
                                <div class="col-md-4">
                                    <input type="text" name="name" class="form-control" id="proname" placeholder="名称">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label"><span class="red">*</span>海报</label>
                            ...
                            <div class="form-group">
                                <label class="control-label"><span class="red">*</span>链接</label>
                                <div class="col-md-4">
